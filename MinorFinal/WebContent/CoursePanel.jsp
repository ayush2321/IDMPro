...
if(rs.next())
{
	...
	%>
                            ...
                            <tbody>
									...
									<td><input type=text name=courseId value="<%=courseId%>" readonly/></td> 
    								<td><input type=text name=courseName  value="<%=courseName %>" /></td>
									<td><input type=text name=fees value="<%=fees %>" /></td> 
...
<tr>
    ...
    <td><input type=text name=courseName placeholder="Enter Couse Name"/></td>
